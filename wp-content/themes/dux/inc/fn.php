...
function _the_logo() {
	...
	echo '<' . $tag . ' class="logo"><a href="' . get_bloginfo('url') . '" title="' . get_bloginfo('name') . _get_delimiter() . get_bloginfo('description') . '"><img src="'._hui('logo_src').'" width="215px" height="48px">' . get_bloginfo('name') . '</a></' . $tag . '>';
